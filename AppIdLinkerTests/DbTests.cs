...
namespace AppIdLinker.Tests
{
	...
	public class DbTests
	{
		...
		{
			Db.Init(_testDb);
			string desc = Db.AddToDesc("ftp://demo.com/random/extra/noise", "Doof.\n\nAssociated Android app IDs:\ncom.already.here\ncom.here.already");
			Assert.AreEqual("Doof.\n\nAssociated Android app IDs:\ncom.already.here\ncom.demo.test\ncom.fox.test\ncom.here.already\nuk.co.blue.orca", desc);
		}

		[TestMethod()]
		public void RemoveFromDescTest0()
		{
			string desc = Db.RemoveFromDesc("Old email used with this account was blegh@bademail.com\n\nAssociated Android app IDs:\ncom.demo.test\ncom.fox.test\nuk.co.blue.orca");
